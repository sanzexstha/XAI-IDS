            ...
            if show_all:
                ...
                out_dict = dict(
                    map(
                        ...
                        zip(
                            self.feature_indexes, fnames, self.feature_values, fweights
                        ),
                    )
                )
...
class LimeTabularExplainer(object):
    ...
    def __init__(
        ...
        for feature in self.categorical_features:
            ...
            self.feature_frequencies[feature] = np.array(frequencies) / float(
                sum(frequencies)
            )
    ...
    def explain_instance(
        ...
        # print(f"LIME original score of explanation is: {ret_exp.score[1]}")
